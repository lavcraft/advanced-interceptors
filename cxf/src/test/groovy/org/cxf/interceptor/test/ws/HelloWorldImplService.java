 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://ws.test.lavcraft", wsdlLocation = "file:/Users/tolkv/git/testing-with-wiremock/app/src/test/resources/wsdl/HelloWorld.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://ws.test.lavcraft", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/Users/tolkv/git/testing-with-wiremock/app/src/test/resources/wsdl/HelloWorld.wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://ws.test.lavcraft", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.test.lavcraft", "HelloWorldImplPort"), HelloWorld.class, features);
    }
